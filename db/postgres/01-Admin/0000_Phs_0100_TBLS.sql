...
( Id            BIGINT NOT NULL,                                -- مفتاح رئيسي
  GId           VARCHAR(50) Default replace(gen_random_uuid()::text,'-','') NOT NULL,      -- المفتاح الوحيد
  Status_Id     BIGINT Default 1 NOT NULL,                       -- الحالة 1 فعال - 2 غير فعال - 3 ملغى
  FDate         TIMESTAMP NOT NULL,                                      -- التاريخ
  Name          VARCHAR(100) NOT NULL,                        -- الاسم
...
( Id            BIGINT NOT NULL,	  	                          -- مفتاح رئيسي
  GId           VARCHAR(50) Default replace(gen_random_uuid()::text,'-','') NOT NULL,		  -- المفتاح الوحيد
  Status_Id     BIGINT Default 1 NOT NULL,                       -- الحالة 1 فعال - 2 غير فعال - 3 ملغى
  CDate         TIMESTAMP NOT NULL,                                      -- التاريخ
  Name          VARCHAR(100) NOT NULL,		  	                -- الاسم
  Rem           VARCHAR(200),		                              -- ملاحظات
...
( Id            BIGINT NOT NULL,	  	                          -- مفتاح رئيسي
  ...
  Status_Id     BIGINT Default 1 NOT NULL,                       -- الحالة 1 فعال - 2 غير فعال - 3 ملغى
  CDate         TIMESTAMP NOT NULL,                                      -- تاريخ الإضافة
  EDate         TIMESTAMP NOT NULL,                                      -- تاريخ الانتهاء
  Name          VARCHAR(100) NOT NULL,		  	                -- الاسم
...
( Id            BIGINT NOT NULL,	                            -- مفتاح رئيسي
  GId           VARCHAR(50) Default replace(gen_random_uuid()::text,'-','') NOT NULL,		-- مفتاح التطبيق
