...
CREATE SEQUENCE IF NOT EXISTS Notif_Cod_Type_Seq
  INCREMENT BY 1
  START WITH 1;
...
CREATE SEQUENCE IF NOT EXISTS Notif_Cod_fld_Kind_Seq
  INCREMENT BY 1
  START WITH 1;
...
CREATE SEQUENCE IF NOT EXISTS Notif_Cod_Event_Seq
  INCREMENT BY 1
  START WITH 1;
...
CREATE SEQUENCE IF NOT EXISTS Notif_Cod_Cont_Type_Seq
  INCREMENT BY 1
  START WITH 1;
...
CREATE SEQUENCE IF NOT EXISTS Notif_Cod_Dest_Type_Seq
  INCREMENT BY 1
  START WITH 1;
...
CREATE SEQUENCE IF NOT EXISTS Notif_Table_Seq
  INCREMENT BY 1
  START WITH 1;
...
( Id           BIGINT NOT NULL,                                                                -- مفتاح رئيسي
  ...
  DDate        TIMESTAMP Default LOCALTIMESTAMP,                                                               -- تاريخ الإرسال
  RDate        TIMESTAMP,                                                                               -- تاريخ الاستقبال 
  SDate        TIMESTAMP,                                                                               -- تاريخ الرؤية
