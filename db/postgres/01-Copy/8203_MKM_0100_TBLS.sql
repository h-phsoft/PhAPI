...
CREATE SEQUENCE IF NOT EXISTS MKM_Cod_Cntry_Seq
  INCREMENT BY 1
  START WITH 1;
...
CREATE SEQUENCE IF NOT EXISTS MKM_Cod_ReqStatus_Seq
  INCREMENT BY 1
  START WITH 1;
...
CREATE SEQUENCE IF NOT EXISTS MKM_Cod_IStatus_Seq
  INCREMENT BY 1
  START WITH 1;
...
CREATE SEQUENCE IF NOT EXISTS MKM_Brand_Seq
  INCREMENT BY 1
  START WITH 1;
...
( Id         BIGINT NOT NULL,                        -- مفتاح رئيسي
  ...
  Wdays      INTEGER Default 365,                      -- أيام الضمان
...
( Id         BIGINT NOT NULL,                        -- مفتاح رئيسي
  ...
  Qnt        NUMERIC(10,2) Default 0,                     -- الكمية
  Price      NUMERIC(10,2) Default 0,                     -- السعر العادي
  Cprice     NUMERIC(10,2) Default 0,                     -- السعر الحالي
...
( Id         BIGINT NOT NULL,                        -- مفتاح رئيسي
  ...
  Qnt        NUMERIC(10,2) Default 1,                     -- الكمية
  Cqnt       NUMERIC(10,2) Default 1,                     -- الكمية الحالية
  Created_At TIMESTAMP Default LOCALTIMESTAMP,                         -- تاريخ الإنشاء
  Ins_User   BIGINT, Ins_Date     TIMESTAMP,
  Upd_User   BIGINT, Upd_Date     TIMESTAMP,
...
( Id         BIGINT NOT NULL,                        -- مفتاح رئيسي
  ...
  Mdate      TIMESTAMP Default LOCALTIMESTAMP,                       -- التاريخ
...
( Id         BIGINT NOT NULL,                        -- مفتاح رئيسي
  ...
  Wdays      INTEGER Default 0,                        -- أيام الضمان
...
CREATE SEQUENCE IF NOT EXISTS MKM_Sale_Upd_Seq
  INCREMENT BY 1
  START WITH 1;
...
CREATE SEQUENCE IF NOT EXISTS MKM_Sale_Del_Seq
  INCREMENT BY 1
  START WITH 1;
...
CREATE SEQUENCE IF NOT EXISTS MKM_Ticket_Seq
  INCREMENT BY 1
  START WITH 1;
...
( Id             BIGINT NOT NULL,                         -- مفتاح رئيسي
  ...
  Status_Id      BIGINT Default 1,                         -- الحالة
  User_Id        BIGINT,                                   -- المستخدم
  Tdate          TIMESTAMP Default LOCALTIMESTAMP,                        -- تاريخ التذكرة
  Udate          TIMESTAMP Default LOCALTIMESTAMP,                        -- تاريخ التحديث
...
( Id         BIGINT NOT NULL,                         -- مفتاح رئيسي
  ...
  nLong      NUMERIC(20,10) Default 0,                       -- خط الطول
  nLat       NUMERIC(20,10) Default 0,                       -- خط العرض
