...
( Id             BIGINT AUTO_INCREMENT,                           -- مفتاح رئيسي
  ...
  CCom           DECIMAL(25,2) Default 0,              -- العمولة عملة
  Com            DECIMAL(25,2) Default 0,              -- العمولة محلي
  ExCCom         DECIMAL(25,2) Default 0,              -- العمولة فعلي عملة
  ExCom          DECIMAL(25,2) Default 0,              -- العمولة فعلي محلي
  ...
  MDate          DATETIME,                                -- تاريخ الشيك\التحويل المصرفي\الحوالة الهاتفية\التحويل
  Bank_Id        BIGINT,                           -- البنك
  City_Id        BIGINT Default 0,                 -- المدينة
  PhnBy          MEDIUMINT Default 0,                 -- شركة التحويل
  ...
  TDate          DATETIME,                                -- تاريخ و وقت إنشاء ورقة التحويل
...
( Id             BIGINT AUTO_INCREMENT,                           -- مفتاح رئيسي
  ...
  FCCom          DECIMAL(25,2) Default 0,              -- العمولة عملة من
  FCom           DECIMAL(25,2) Default 0,              -- العمولة محلي من
  TCCom          DECIMAL(25,2) Default 0,              -- العمولة عملة الى
  TCom           DECIMAL(25,2) Default 0,              -- العمولة محلي الى
  ExFCCom        DECIMAL(25,2) Default 0,              -- العمولة فعلي عملة من
  ExFCom         DECIMAL(25,2) Default 0,              -- العمولة فعلي محلي من
  ExTCCom        DECIMAL(25,2) Default 0,              -- العمولة فعلي عملة الى
  ExTCom         DECIMAL(25,2) Default 0,              -- العمولة فعلي محلي الى
  Status_Id      BIGINT Default 0,                 -- الحالة
  Status_Date    DATETIME,                                -- التاريخ
  Status_Descr   VARCHAR(100),                  -- الشرح
  MNum           VARCHAR(30),                   -- رقم الشيك\التحويل المصرفي\الحوالة الهاتفية\التحويل
