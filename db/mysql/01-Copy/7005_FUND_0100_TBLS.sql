...
( Id          BIGINT AUTO_INCREMENT,                                   -- مفتاح رئيسي
  ...
  nPrints     TINYINT Default 0,                         -- عدد مرات الطباعة
  dDate       DATETIME NOT NULL,                               -- التاريخ
  CAmt        DECIMAL(25,3) DEFAULT 0 NOT NULL,             -- المبلغ قطع
  Rate        DECIMAL(25,7) DEFAULT 1 NOT NULL,             -- سعر الصرف
  Amt         DECIMAL(25,3) DEFAULT 0 NOT NULL,             -- المبلغ
  Rem         VARCHAR(100),                               -- ملاحظات
