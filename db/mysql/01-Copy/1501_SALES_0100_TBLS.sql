...
( Id         BIGINT NOT NULL AUTO_INCREMENT,                           -- الرقم
  dDate      DATETIME NOT NULL,                                -- تاريخ
  Name       VARCHAR(100) NOT NULL,                  -- الاسم
  Rem        VARCHAR(100),                           -- ملاحظات
  Ins_User   BIGINT, Ins_Date   DATETIME,
  Upd_User   BIGINT, Upd_Date   DATETIME,
...
( Id         BIGINT NOT NULL AUTO_INCREMENT,				                   -- مفتاح رئيسي
  ...
  Cmv        DECIMAL(17,3),                                 -- نسبة العمولة
  Com        DECIMAL(17,3),                                 -- العمولة
  BCom       DECIMAL(17,3),                                 -- العمولة الأساس
  Ccom       DECIMAL(17,3),                                 -- العمولة قطع
